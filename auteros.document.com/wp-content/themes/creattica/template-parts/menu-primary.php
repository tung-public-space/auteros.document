...
if ( has_nav_menu( 'primary' ) ) : // Check if there's a menu assigned to the 'primary' location.
	...
	?>
	<div class="screen-reader-text"><?php _e( 'Primary Navigation Menu', 'creattica' ); ?></div>
	<nav <?php hybridextend_attr( 'menu', 'primary' ); ?>>
		<div class="menu-toggle"><span class="menu-toggle-text"><?php _e( 'Menu', 'creattica' ); ?></span><i class="fas fa-bars"></i></div>
