...
function hoot_theme_customizer_options() {
	...
	$sections[ $section ] = array(
		'title'       => __( 'Demo Install / Support', 'creattica' ),
		'priority'    => '2',
	);
	...
	$lcontent .= '<a class="hoot-cust-link" href="' .
				 ...
				 esc_html__( "1 Click Installation", 'creattica') . 
				 '</span><span class="hoot-cust-link-desc">' .
				 esc_html__( "Install demo content to make your site look exactly like the Demo Site. Use it as a starting point instead of starting from scratch.", 'creattica') .
				 '</span></a>';
	$lcontent .= '<a class="hoot-cust-link" href="' .
	...
	$lcontent .= '<a class="hoot-cust-link" href="' .
				 ...
				 sprintf( esc_html__( 'If you are happy with the theme, please give us a %1$s rating on wordpress.org. Thanks in advance!', 'creattica'), '<span style="color:#0073aa;">&#9733;&#9733;&#9733;&#9733;&#9733;</span>' ) .
				 '</span></a>';
	...
	$settings['sidebar_fp'] = array(
		'label'       => __( 'Sidebar Layout (for Front Page)', 'creattica' ),
		'section'     => $section,
		'type'        => 'radioimage',
		'choices'     => array(
			'wide-right'         => $imagepath . 'sidebar-wide-right.png',
		...
		'description' => sprintf( esc_html__( 'This is sidebar for the Frontpage Content Module in %1$sFrontpage Modules Settings%2$s', 'creattica' ), '<a href="' . esc_url( admin_url( 'customize.php?autofocus[control]=frontpage_content_desc' ) ) . '" rel="focuslink" data-focustype="control" data-href="frontpage_content_desc">', '</a>' ),
	);

	$settings['sidebar_archives'] = array(
		'label'       => __( 'Sidebar Layout (for Blog/Archives)', 'creattica' ),
		'section'     => $section,
		'type'        => 'radioimage',
		'choices'     => array(
			'wide-right'         => $imagepath . 'sidebar-wide-right.png',
	...
	$sections[ $section ] = array(
		...
		// 'description' => __( 'Control even more color options in the premium version for fonts, backgrounds, contrast, highlight, accent etc.', 'creattica' ),
	);
	...
	$sections[ $section ] = array(
		...
		// 'description' => __( 'The premium version comes with a separate Slider type allowing creation of Unlimited slides.', 'creattica' ),
	);
...
/* Transition filter for version 1.8.8 : Doesnt resolve customizer but hopefully user will visit atleast one admin screen before customizer */
add_filter( 'hoot_get_mod', 'hoot_transition_get_mods', 2 );

/**
 * Function for seamless transition for changed option/values in version 1.8.8
 * Updated 1.8.8 for frontpage sidebar option
 *
 * @since 1.8.8
 * @access public
 * @return void
